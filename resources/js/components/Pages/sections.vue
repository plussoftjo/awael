<template>
  <div>
    <v-toolbar flat color="black">
      <v-toolbar-title>ألاقسام الرئيسية</v-toolbar-title>
      <v-divider
        class="mx-2"
        inset
        vertical
      ...
      <v-dialog v-model="dialog" max-width="500px">
        <template v-slot:activator="{ on }">
          <v-btn color="primary" dark class="mb-2" v-on="on">اضافة قسم جديد</v-btn>
        </template>
        <v-card>
          <v-card-title>
            ...
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 v-if="error">
                  <p style="color:red;font-weight:700;">يوجد خطا الرجاء التأكد من الحقول </p>
                </v-flex>
              </v-layout>
            </v-container>
          </v-card-text>
